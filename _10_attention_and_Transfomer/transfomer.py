# 使用encoder-decoder架构整合成一个可训练的transfomer模型

import torch
import torch.nn as nn
import torch.nn.functional as F
from encoder_decoder import transfomer_encoder,transfomer_decoder,create_masks,Pad
    ...
    def generate(
        ...
        for step in range(max_len - 1):
            ...
            decoder_output, _, _ = self.decoder(
                ...
                memory_valid_len=src_valid_len  # 添加
            )
